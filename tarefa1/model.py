...
class ModelCNNNoBN(nn.Module):
    def __init__(self):
        super(ModelCNNNoBN, self).__init__()
...
class ModelCNNNoDropout(nn.Module):
    def __init__(self):
        super(ModelCNNNoDropout, self).__init__()
...
class ModelCNNHighDropout(nn.Module):
    def __init__(self):
        super(ModelCNNHighDropout, self).__init__()
